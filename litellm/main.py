    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "azure":
            ...
            api_key = (
                api_key
                or litellm.apimart_key
                or get_secret_str("APIMART_API_KEY")
            ...
            api_base = (
                api_base
                or litellm.api_base
                or get_secret_str("APIMART_API_BASE")
                or "https://api.apimart.ai/v1"
            )
            ...
            api_key = (
                api_key
                or litellm.comflychat_key
                or get_secret_str("COMFLYCHAT_API_KEY")
            ...
            api_base = (
                api_base
                or litellm.api_base
                or get_secret_str("COMFLYCHAT_API_BASE")
                or "https://ai.comfly.chat/v1"
            )
            ...
            api_key = (
                api_key
                or litellm.funcloud_key
                or get_secret_str("FUNCLOUD_API_KEY")
            ...
            api_base = (
                api_base
                or litellm.api_base
                or get_secret_str("FUNCLOUD_API_BASE")
                or "https://funcloud.ai/v1"
            )
            ...
            api_key = (
                api_key
                or litellm.onerouter_key
                or get_secret_str("ONEROUTER_API_KEY")
            ...
            api_base = (
                api_base
                or litellm.api_base
                or get_secret_str("ONEROUTER_API_BASE")
                or "https://llm.onerouter.pro/v1"
            )
