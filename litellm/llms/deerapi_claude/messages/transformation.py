"""
DeerAPI Claude provider implementation for Anthropic /v1/messages API
...
# 默认 API 地址（包含完整路径）
DEFAULT_API_BASE = "https://api.deerapi.com/v1/messages"


class DeerapiClaudeMessagesConfig(AnthropicMessagesConfig):
    """
    DeerAPI Claude provider implementation for Anthropic /v1/messages API
    ...
    def get_complete_url(
        ...
        api_base = (
            ...
            or get_secret_str("DEERAPI_CLAUDE_API_BASE")
            or DEFAULT_API_BASE
        )
    ...
    def validate_anthropic_messages_environment(
        ...
        if api_key is None:
            api_key = (
                ...
                or get_secret_str("DEERAPI_CLAUDE_API_KEY")
            )
