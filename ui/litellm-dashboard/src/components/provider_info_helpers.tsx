export enum Providers {
  ...
  xAI = "xAI",
  DeerAPI = "DeerAPI",
  DeerAPI_Gemini = "DeerAPI Gemini",
  DeerAPI_Claude = "DeerAPI Claude",
  InfiniAI = "InfiniAI",
  BLTCY = "BLTCY",
  XiakeXing = "XiakeXing",
  ShuBiaoBiao = "ShuBiaoBiao",
  OmniLink = "OmniLink",
  OminiLink_Gemini = "OminiLink Gemini",
  OneRouter = "OneRouter",
  FunCloud = "FunCloud",
...
export const provider_map: Record<string, string> = {
  ...
  xAI: "xai",
  DeerAPI: "deerapi",
  DeerAPI_Gemini: "deerapi_gemini",
  DeerAPI_Claude: "deerapi_claude",
  InfiniAI: "infiniai",
  BLTCY: "bltcy",
  XiakeXing: "xiakexing",
  ShuBiaoBiao: "shubiaobiao",
  OmniLink: "omnilink",
  OminiLink_Gemini: "ominilink_gemini",
  OneRouter: "onerouter",
  FunCloud: "funcloud",
...
export const providerLogoMap: Record<string, string> = {
  ...
  [Providers.DeerAPI_Gemini]: `${asset_logos_folder}deerapi.jpeg`,
  [Providers.DeerAPI_Claude]: `${asset_logos_folder}deerapi.jpeg`,
  ...
  [Providers.OminiLink_Gemini]: `${asset_logos_folder}omnilink.png`,
